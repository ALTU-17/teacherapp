...
class AddTeacherNote extends StatefulWidget {
  const AddTeacherNote({super.key});

  @override
  State<AddTeacherNote> createState() => _AddTeacherNote();
}

class _AddTeacherNote extends State<AddTeacherNote> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Add Teacher Note(2024-2025)" ,style: TextStyle(color: Colors.white), ),
