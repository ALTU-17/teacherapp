...
class EditTeacherNote extends StatefulWidget {
  const EditTeacherNote({super.key});

  @override
  State<EditTeacherNote> createState() => _EditTeacherNote();
}

class _EditTeacherNote extends State<EditTeacherNote> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Edit Teacher Note(2024-2025)" ,style: TextStyle(color: Colors.white), ),
