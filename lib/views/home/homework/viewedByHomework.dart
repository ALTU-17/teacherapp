...
class ViewedByHomeWork extends StatefulWidget {
  final Map<String, String> note;

  const ViewedByHomeWork({super.key, required this.note});

  @override
  _ViewedByHomeWork createState() => _ViewedByHomeWork();
}

class _ViewedByHomeWork extends State<ViewedByHomeWork> {
